...
def test_invalid_yaml_syntax(sample_df: pd.DataFrame, tmp_path: str):
    """Raise ValueError if YAML file is syntactically invalid."""
    bad_file = tmp_path / "bad.yml"
    bad_file.write_text("::::bad_yaml:::")
    validator = Expectations(sample_df, str(bad_file))
